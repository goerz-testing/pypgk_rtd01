...
Everyone interacting in the PyPgk RTD01 project's code base,
...
Report bugs at https://github.com/goerz-testing/pypgk_rtd01/issues.
...
The best way to send feedback is to file an issue at https://github.com/goerz-testing/pypgk_rtd01/issues.
...
3. Check https://travis-ci.org/goerz-testing/pypgk_rtd01/pull_requests
...
Ready to contribute? Follow `Aaron Meurer's Git Workflow Notes`_ (with ``goerz-testing/pypgk_rtd01`` instead of ``sympy/sympy``)

In short,

1. Clone the repository from ``git@github.com:goerz-testing/pypgk_rtd01.git``
...
PyPgk RTD01 uses a simple branching model where all
...
PyPgk RTD01 includes a full test-suite using pytest_.
...
.. _test coverage: https://coveralls.io/github/goerz-testing/pypgk_rtd01?branch=master
...
PyPgk RTD01 could always use more documentation, whether
...
At any point, from a checkout of the ``pypgk_rtd01``
...
:mod:`pypgk_rtd01` package:

.. doctest::

    >>> import pypgk_rtd01
    >>> pypgk_rtd01.__version__   # doctest: +SKIP
...
https://github.com/goerz-testing/pypgk_rtd01/releases.
